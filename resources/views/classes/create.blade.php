    ...
    <form action="{{ route('classes.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 5px;">
                ...
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; background: var(--bg-main); padding: 8px 12px; border-radius: var(--border-radius-sm); font-size: 0.9rem;">
