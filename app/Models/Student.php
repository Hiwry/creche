...
class Student extends Model
{
     ...
     * Get the documents.
     */
    public function authorizedPersons(): \Illuminate\Database\Eloquent\Relations\BelongsToMany
    {
        return $this->belongsToMany(AuthorizedPerson::class, 'authorized_person_student');
    }
    ...
    /**
     * Get the sport enrollments.
     */
    public function sportEnrollments(): HasMany
    {
        return $this->hasMany(SportEnrollment::class);
    }

    /**
     * Get active sport enrollments.
     */
    public function activeSportEnrollments(): HasMany
    {
        return $this->hasMany(SportEnrollment::class)->where('status', 'active');
    }

    /**
     * Get sports through enrollments.
     */
    public function sports()
    {
        return $this->belongsToMany(Sport::class, 'sport_enrollments')
                    ->withPivot(['monthly_fee', 'start_date', 'status'])
                    ->wherePivot('status', 'active');
    }
